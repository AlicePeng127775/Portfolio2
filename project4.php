...
<head>
    ...
    <!-- Open Graph Meta Tags -->
        <meta property="og:title" content="Alice Peng - Whac-A-Mole Website GameWebsite">
    ...
    <!-- Twitter Card Meta Tags -->
        ...
        <meta name="twitter:title" content="Alice Peng - Whac-A-Mole Website GameWebsite">
        ...
        <div class='project grid'>
            <div class='projectInfo col-12' data-aos="fade-up">                
                    <div class='projectIntro col-12'>
                        <div class='project4C col-12 grid'>                        

                            <div class='projectIMG col-12 col-6-lg'><img src='./img/project/Moblio04.png' alt='October shopping app design laptop Mockup'></div>
